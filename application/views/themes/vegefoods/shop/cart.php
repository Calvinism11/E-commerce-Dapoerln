...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bgmentai.jpg'); ?>');">
  ...
  <section class="ftco-section ftco-Keranjang Belanja">
          ...
          <?php else : ?>
            <div class="row">
              <div class="col-md-12 ftco-animate">
                <div class="alert alert-info">Tidak ada barang dalam keranjang.<br><p class="copyright-agileinfo">  Jelajai Toko Kami <?php echo anchor(base_url(), get_store_name()); ?></p>
            </div>
          <?php endif; ?>
          </div>
      </section>
