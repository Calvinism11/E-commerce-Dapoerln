...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bgmentai.jpg'); ?>');">
    <div class="container">
    ...
    <form action="<?php echo site_url('shop/checkout/order'); ?>" method="POST">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-7 ftco-animate">
                ...
                <div class="form-group">
                    <label for="address" class="form-control-label">Pilih Provinsi:</label>
                    <select class="form-control" id="provinsi" name="provinsi_id">
                        <option value="">Pilih Provinsi</option>
                        <?php foreach ($provinsi as $key => $item) { ?>
                ...
                <div class="form-group">
                    <label for="address" class="form-control-label">Pilih Kabupaten:</label>
                ...
                <div class="form-group">
                    <label for="address" class="form-control-label">Pilih Expedisi:</label>
                    <select class="form-control" id="expedisi" name="expedisi">
                        <option value="">Pilih Expedisi</option>
                        <option value="pos">Go Food</option>
                        <option value="pos">Grab Food</option>
                        <option value="pos">Shopee Food</option>
						<option value="jne">JNE</option>
						<option value="tiki">J&T</option>
                    </select>
                </div>
