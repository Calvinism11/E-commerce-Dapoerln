    ...
    <div class="container">
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><a href="https://www.google.com/maps?q=Klinik Laptop" target="blank"><span class="icon icon-map-marker"></span><span class="text"><?php echo get_settings('store_address'); ?></span></a></li>
                  <li><a href="https://wa.me/<?php echo get_settings('store_phone_number'); ?>" target="blank"><span class="icon icon-phone"></span><span class="text"><?php echo get_settings('store_phone_number'); ?></span></a></li>
                  <li><a href="https://mail.google.com/mail/?view=cm&fs=1&to=<?php echo get_settings('store_email'); ?>" target="blank"><span class="icon icon-envelope"></span><span class="text"><?php echo get_settings('store_email'); ?></span></a></li>
                </ul>
              </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p>
          &copy; 2024 <?php echo get_store_name(); ?>.
                      </p>
        </div>
      </div>
    </div>
