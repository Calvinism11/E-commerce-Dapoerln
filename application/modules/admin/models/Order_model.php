...
class Order_model extends CI_Model
{
    ...
    public function get_all_orders($limit, $start, $search = null)
    {
        ...
        $this->db->select('o.id, o.order_number, o.order_date, o.order_status, o.payment_method, o.total_price, o.total_items, c.name AS coupon, cu.name AS customer,o.ongkir')
