...
class Products extends CI_Controller {
    ...
    public function add_new_product()
    {
        ...
        $product['flash'] = $this->session->flashdata('pesan_gagal');
    ...
    {
        // $this->session->set_flashdata('pesan', 'Produk Ini Sudah Ada!');
        
        $this->form_validation->set_error_delimiters('<div class="form-error text-danger font-weight-bold">', '</div>');

        $this->form_validation->set_rules('name', 'Nama produk', 'trim|required|min_length[4]|max_length[255]|is_unique[products.name]');
        ...
        if ($this->form_validation->run() == FALSE)
        {
            ...
            {
                $this->session->set_flashdata('pesan_gagal', 'Produk Ini Sudah Ada, Gagal Ditambahkan!');
            }
            else {
                $this->session->set_flashdata('pesan_gagal', 'Produk Ini Sudah Ada, Gagal Ditambahkan!');
            }
